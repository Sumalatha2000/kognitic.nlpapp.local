...
@Component
public class DosageReader implements AnnotationReader {
	private static final Logger log = LoggerFactory.getLogger(DosageReader.class);
	...
	private List<Dosage> indicationsList;
	...
	public void saveAnnotationSet() {
		if (CollectionUtils.isNotEmpty(indicationsList)) {
			dosageService.saveAll(indicationsList);
